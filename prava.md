...
# Zakáže zápis (w) pro skupinu (g) a ostatní (o)
chmod go-w soubor.txt

# Smaže všechna práva pro skupinu (g) a ostatní (o)
chmod go= soubor.txt
...
# Typické nastavení pro veřejný adresář (všichni rwx + sticky bit)
chmod a+rwxt /tmp/verejny

# Nastaví 'rw' pro všechny A ZÁROVEŇ přidá 'x' (velké X),
# pokud je to adresář nebo pokud soubor už 'x' měl.
chmod a=rw,+X adresar
